...
export default async function handler(req, res) {
    try {
        ...
        console.log('Request body:', { to: Array.isArray(to) ? `${to.length} recipients` : to, subject, hasHtml: !!html, hasText: !!text });
        ...
        console.log('Sending email via SES to:', toAddresses.length, 'recipients');
