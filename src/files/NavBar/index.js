        ...
        <StyledAppBar position="sticky">
            <StyledToolbar>
                ...
                <NavLinks>
                    {isAuthenticated ? (
                        <>
                            <NavButton onClick={() => router.push('/Player')}>
                                My Leagues
                            </NavButton>
                            <NavButton onClick={() => router.push('/CreateLeague')}>
                                Create League
                            </NavButton>
                        ...
                        <>
                            ...
                            <NavButton onClick={() => router.push('/SignIn')}>
                                Sign In
                            </NavButton>
                            <NavButtonPrimary onClick={() => router.push('/SignIn')}>
                                Get Started
                            </NavButtonPrimary>
                        </>
                    )}
